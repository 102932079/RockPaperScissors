//after define method we can move the class into the separate file with model folder
...
//     { // the name of the method(submit)//`the name of the controller(vote)/what it is(request)/named model because of no impelmentation 
